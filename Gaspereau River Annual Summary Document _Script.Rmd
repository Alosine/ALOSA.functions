...
- \fancyhead[L]{Gaspereau River 2023 Assessment Summary}
- \fancyfoot[R]{\thepage}
...
------- | -------------| ------------------| -------------| --------
2024| *1,200,000*| 588,215+/-31,209| *1,788,215* |*67.1*
2023| 1,431,500| 1,312,700+/-52,246| 2,744,200 |52.2
...
text(3.38,1.02,"2023",pos=3,col="red",cex=0.85)
...
lines(GRdata$daynum[GRdata$year==plotyear],GRdata$number[GRdata$year==plotyear]/1000,
      lty=1,lwd=1.5)
text(63,ymax,plotyear,cex=2)
text(-2,ymax,paste("Total =", GR$escape[!is.na(GR$year==plotyear)& GR$year==plotyear],sep=" "),cex=1.5,pos=4)
...
**Figure 4.** Estimated number of Alewife ascending the White Rock fish ladder in 2013, 2015 and 2016.

\newpage
```{r dailyplot2,echo=FALSE, fig.width = 7.5,fig.height = 9}
plotyears=c(2017,2018,2019)
ymax<-max(GRdata$number[GRdata$year %in% plotyears])/1000
...
**Figure 5.** Estimated number of Alewife ascending the White Rock fish ladder in 2017-2019.

\newpage
```{r dailyplot3,echo=FALSE, fig.width = 7.5,fig.height = 9}
plotyears=c(2021,2022,2023)
...
**Figure 6.** Estimated number of Alewife ascending the White Rock fish ladder in 2021-20123.
