...
series23.present=TR[TR$year==2023,]
...
points(series23.present$escape/ssnmsy,series23.present$er/Fupper,pch=19)
lines(series23.present$escape/ssnmsy,series23.present$er/Fupper)
...
text(0.7,0.82,"2023",pos=4,col="gray35",cex=0.85)
```
